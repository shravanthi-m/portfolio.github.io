...
const projects = [
    {
        id: 1,
        title: "Meal Planner",
        description: "A web app that suggests weekly meal plans based on user preferences and dietary restrictions.",
...
// add project screenshots to projects folder inside public folder
